<template>
  <div class="grid h-full grid-cols-1 gap-6 lg:grid-cols-3">
    ...
    <div
      class="p-6 overflow-y-auto bg-white border shadow-sm border-neutral-200 lg:col-span-1 dark:bg-neutral-900 rounded-xl dark:border-neutral-800 dark:shadow-none">
    ...
    <!-- Builder Form -->
    <div
      class="p-6 overflow-y-auto bg-white border shadow-sm border-neutral-200 lg:col-span-2 dark:bg-neutral-900 rounded-xl dark:border-neutral-800 dark:shadow-none">
      ...
      <div class="space-y-6">
        ...
        <div>
          ...
          <Select v-model="selectedCheckpoint" :options="store.checkpoints" option-value="id" option-label="name" placeholder="Select Checkpoint" raised fluid>
            <template #option="slotProps"> {{ slotProps.option.name }} ({{ slotProps.option.version }}) </template>
          </Select>
        </div>
        ...
        <div>
          ...
          <div
            ...
            <div
              ...
              <span
                :class="['text-sm truncate', selectedLoras.includes(lora.id) ? 'text-blue-900 dark:text-blue-200' : 'text-neutral-700 dark:text-neutral-300']">
                {{ lora.name }}
              </span>
